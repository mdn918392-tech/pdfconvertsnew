...
import { Download, ArrowLeft, FileText, Scissors, Eye, Filter, Shield, Zap, CheckCircle, Sparkles, File } from 'lucide-react';
        ...
        >
          ...
          <AnimatePresence>
            {showUploadInfo && (
              ...
              >
                <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/30 dark:to-purple-950/30 p-4 md:p-6 rounded-2xl border-2 border-blue-200 dark:border-blue-800/50">
                  <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
                    ...
                    <h3 className="text-lg md:text-xl font-bold text-gray-900 dark:text-white">Selective Extraction</h3>
                  </div>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30 p-4 md:p-6 rounded-2xl border-2 border-purple-200 dark:border-purple-800/50">
                  <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
                    ...
                    <h3 className="text-lg md:text-xl font-bold text-gray-900 dark:text-white">Fast Processing</h3>
                  </div>
                  <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400">
