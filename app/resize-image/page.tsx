...
export default function ResizeImage() {
  ...
  const [resizeOptions, setResizeOptions] = useState<ResizeOptions>({
    width: 1920, // Default to Full HD
    height: 1080,
    maintainAspectRatio: true,
    quality: 90, // Higher quality for HD
    format: "jpg" as const,
  });
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-3 sm:mb-4">
                        <button
                          ...
                          className={`px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg border text-xs sm:text-sm font-medium transition-all ${
                        ...
                        {presetCategories.map((category) => (
                          <button
                            ...
                            className={`px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg border text-xs sm:text-sm font-medium transition-all flex items-center gap-1 sm:gap-1.5 ${
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-1.5 sm:gap-2 md:gap-3">
                        {filteredPresets.map((preset, index) => (
                          <button
                            ...
                            className={`p-2 sm:p-3 rounded-lg border transition-all duration-300 text-left group ${
                          ...
                          >
                            <div className="flex items-center gap-1.5 sm:gap-2 mb-1 sm:mb-2">
                              <div className="p-1 sm:p-1.5 bg-gray-100 dark:bg-gray-800 rounded-lg">
                                <preset.icon className="w-3 h-3 sm:w-4 sm:h-4 text-gray-600 dark:text-gray-400" />
                              </div>
                            ...
                            <div className="text-[10px] sm:text-xs text-gray-400 dark:text-gray-500 mt-0.5">
                              {preset.description}
                            </div>
                          </button>
                        ))}
      ...
      <div className="grid gap-6 md:grid-cols-4">
        <div className="border rounded-xl p-6 text-center shadow-sm bg-white">
          ...
          <p className="text-gray-600 text-sm mt-2">
            Upload JPG, PNG, or WebP images using drag & drop or file picker.
          </p>
        </div>

        <div className="border rounded-xl p-6 text-center shadow-sm bg-white">
          <div className="text-4xl font-bold text-green-600 mb-2">2</div>
          <h3 className="font-semibold text-lg">Select Size & Presets</h3>
          <p className="text-gray-600 text-sm mt-2">
            Choose presets like Full HD, 4K, Instagram, or enter custom dimensions.
          </p>
        </div>

        <div className="border rounded-xl p-6 text-center shadow-sm bg-white">
          <div className="text-4xl font-bold text-green-600 mb-2">3</div>
          <h3 className="font-semibold text-lg">Resize with Live Preview</h3>
          <p className="text-gray-600 text-sm mt-2">
            Adjust quality, maintain aspect ratio, and preview changes instantly.
          </p>
        </div>

        <div className="border rounded-xl p-6 text-center shadow-sm bg-white">
          <div className="text-4xl font-bold text-green-600 mb-2">4</div>
          <h3 className="font-semibold text-lg">Download Image</h3>
          <p className="text-gray-600 text-sm mt-2">
            Download resized images in high quality instantly.
          </p>
        </div>
      </div>
    </section>
